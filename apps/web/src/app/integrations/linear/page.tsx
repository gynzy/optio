...
export default function LinearAgentsPage() {
  ...
  // Registration form component (shared between add and edit)
        ...
        <div className="space-y-6">
          ...
          <div className="p-5 rounded-xl border border-border/50 bg-bg-card space-y-3">
            <div className="flex items-center justify-between">
              <h2 className="text-sm font-medium">API Token</h2>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold tracking-tight">Agent Registrations</h2>
              <button
            ...
            {showAddForm && (
              <div className="p-5 rounded-xl border border-border/50 bg-bg-card">
                <h3 className="text-sm font-medium">New Registration</h3>
            ...
            {registrationsLoading ? (
              ...
              <div className="text-center py-12 text-text-muted border border-dashed border-border rounded-lg">
                ...
                <p>No agent registrations</p>
                <p className="text-xs mt-1">
                  Add a registration to connect Linear agents to Optio.
                </p>
              </div>
            ) : (
              <div className="space-y-2">
                {registrations.map((reg) => (
                  <div key={reg.id} className="p-4 rounded-xl border border-border/50 bg-bg-card">
                    {editingId === reg.id ? (
                      <div>
                        <h3 className="text-sm font-medium">Edit Registration</h3>
                        {renderRegistrationForm()}
                      </div>
                    ) : (
                      <div>
